...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        $data['sitter'] = SitterInformation::where('user_id',$id)->first();
    ...
    public function customPaymentPost(Request $request,$id){
        $request->validate([
        ...
        $data->payment_account = $request->payment_account;
        ...
        if(Auth::user()->is_admin == 'sitter'){
            return redirect()->route('sitter.dashboard')->with($notification);
