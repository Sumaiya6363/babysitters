...
<body>
    ...
    <div class="wrapper">
        ...
        <header class="top-header">
            <nav class="navbar navbar-expand gap-3">
                ...
                <a href="{{route('homepage')}}">Back To Website</a>
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">User Menagement</div>
                </a>
                <ul>
                    <li> <a href="{{ route('admin.user.index') }}"><i class="bi bi-circle"></i>Admin Users</a> </li>
                    <li> <a href="{{ route('sitter.user.index') }}"><i class="bi bi-circle"></i>Sitter Users</a>
                    </li>
                    <li> <a href="{{ route('general.user.index') }}"><i class="bi bi-circle"></i>General User</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('product.index') }}"><i class="bi bi-circle"></i>Products</a> </li>
                </ul>
            </li>
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">Products Order </div>
                </a>
                <ul>
                    ...
                    {{-- <li> <a href="{{ route('admin.order.outofdelivery') }}"><i class="bi bi-circle"></i>Out of
                            Delivery</a>
                    </li> --}}
            ...
            <li>
                ...
                <ul>
                    <li> <a href="{{ route('blog.index') }}"><i class="bi bi-circle"></i>Blog </a>
                    </li>
                    <li><a href="{{ route('blog-category.index') }}"><i class="bi bi-circle"></i>Blog Category</a>
                    </li>
            ...
            <li>
                <a href="{{ route('admin.sitter.index') }}">
                    <div class="parent-icon">
                        <i class="fadeIn animated bx bx-box"></i>
                    </div>
                    <div class="menu-title"> Sitters Request </div>
                </a>
            </li>
            <li>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.0.8/sweetalert.min.js"
        integrity="sha512-fcAEThGLlyTKt+mmcRprds9PxumnuZukst32LxyzgU8ga0jKzlHCHawCo+eynUAgrHpuUe1QGSHe6X6cXYcZAg=="
